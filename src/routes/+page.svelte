<script lang="ts">
    ...
    let source: 'reddit' | 'hackernews' | 'wikipedia' | null = null;
    let error: string | null = null;
    let history: Array<{ url: string; title: string; source: 'reddit' | 'hackernews' | 'wikipedia' }> = [];
    ...
    function setStoredData(newItem: { url: string; title: string; source: 'reddit' | 'hackernews' | 'wikipedia' }) {
    ...
    async function fetchRandomPost(source: 'reddit' | 'hackernews' | 'wikipedia') {
        state = 'loading';
    ...
    onMount(() => {
        ...
        // Add keyboard shortcut for Wikipedia button
...
<svelte:head>
    ...
    <meta
        name="description"
        content="Find random, interesting content from Reddit, Hacker News, and Wikipedia with just one click."
    />
    <meta
        name="keywords"
        content="random content, internet discovery, Reddit, Hacker News, Wikipedia, cool websites"
    />
    <meta property="og:title" content="Spotlight - Discover Cool Internet Gems" />
    <meta
        property="og:description"
        content="Click a button, find random, interesting content from Reddit, Hacker News, and Wikipedia with just one click."
    />
    ...
    <meta
        ...
        content="Click a button, find something awesome on the internet. Curated content from Reddit, Hacker News, and Wikipedia."
    />
                        ...
                        {#each history as item, i}
                            ...
                            >
                                <p class="text-sm text-gray-500 mb-2">
                                    {item.source === 'reddit' ? 'Reddit' : item.source === 'hackernews' ? 'Hacker News' : 'Wikipedia'}
                                </p>
